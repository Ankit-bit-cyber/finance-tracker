...
│ │ ├── auth/ # Register, login, profile, OAuth
│ │ ├── user/ # User repository
│ │ ├── transaction/ # CRUD, filters, pagination
│ │ ├── category/ # Custom categories management
│ │ ├── budget/ # Budget goals + progress tracking
│ │ ├── report/ # Monthly & yearly reports
│ │ ├── dashboard/ # Summary + chart data
│ │ ├── upload/ # Receipt file management
...
│ │ ├── helpers.js # Money math, pagination helpers
│ │ └── constants.js # Default categories, currencies
│ │
│ ├── db/
...
│ ├── profile.html # Profile, categories, receipts
...
├── type (income/expense)
├── amount (NUMERIC 15,2)
├── currency, amount_in_base, exchange_rate
├── description, date
├── is_refund, receipt_url
